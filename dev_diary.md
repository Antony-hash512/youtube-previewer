...
- Заголовки сливались, шрифт был слишком жирным и не имел правильных отступов (сайдбар "наезжал" на края). Что очень критично т.к. нужно показать как должно выглядеть на реальном ютубе без тестовых загрузок видео на сам ютуб, чтобы не срабатывали его спам-фильтры, вызывающие временный теневой бан. Добиться правильного отображения с правильными шрифтами и отступами помогло использование ии-агентом браузера для инспектирования кода реального ютуба и извлечения оттуда CSS-правил и шрифтов.
