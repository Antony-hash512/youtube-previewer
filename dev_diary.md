...
- Заголовки сливались, шрифт был слишком жирным и не имел правильных отступов (сайдбар "наезжал" на края). Что очень критично для нужно показать как должно выглядеть на реальном ютубе без тестовых загрузок видео, чтобы не срабатывали спам-фильтры youtube. Добить правильного отображения с правильными шрифтами и отступами помогло использование ии-агентом браузера для инспектирования кода реального ютуба и извлечения оттуда CSS-правил и шрифтов.
